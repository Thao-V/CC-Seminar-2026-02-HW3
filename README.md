# CC-Seminar-2026-02-HW3
# Requirements
1. Setup EC2 Instances
* Launch 2 EC2 instances with Amazon Linux
- Install a web server using the command: sudo dnf install nginx
...
## All screenshots should contain your AWS ID in the top-right corner of your screen.
